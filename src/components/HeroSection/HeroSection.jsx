    ...
    <div className="relative isolate overflow-hidden bg-gray-900  ">
      ...
      <div className="px-6 lg:px-8 ">
        <nav
          ...
          aria-label="Global"
        >
          {/* <div className="hidden lg:flex lg:flex-1 lg:justify-start border-2	border-white">
            <a href="#" className="text-sm font-semibold leading-6 text-white">
              Log in <span aria-hidden="true">&rarr;</span>
            </a>
          </div> */}
          <div className="flex lg:flex-1 border-2	border-white">
          ...
          {/* <div className="flex lg:flex-1 lg:justify-end border-2	border-white">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">Your Company</span>
              <img
                className="h-8"
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end border-2	border-white">
            <a href="#" className="text-sm font-semibold leading-6 text-white">
              Log in <span aria-hidden="true">&rarr;</span>
            </a>
          </div>
