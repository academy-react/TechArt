        ...
        <div className="bg-white lg:px-40">
            ...
            <div className="mt-10 space-y-12 lg:grid lg:grid-cols-3 lg:gap-x-8 lg:space-y-0 gap-y-20 ">
                ...
                {newCard && newCard.map((category) => (
                    ...
                    <h3 className="mt-4 text-base font-semibold text-gray-900">{category.addUserFullName}</h3>
                    <p className="mt-2 text-sm text-gray-500">{category.updateDate}</p>
                    <p className="mt-2 text-sm text-gray-500">{category.insertDate}</p>
